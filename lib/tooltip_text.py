tooltips = {
    ...
    "output_config" : {
        ...
        "category" : "Read-only tag identifying where in the setup heirarchy this file is", 
        "wavelength_range" : "Not Implemented yet, manually select values in the Export Tab",
        "smooth" : "Not Implemented yet, manually select values in the Export Tab",
        "interpolate" : "Not Implemented yet, manually select values in the Export Tab",
        "normalise" : "Not Implemented yet, manually select values in the Export Tab",
        "round" : "Not Implemented yet, manually select values in the Export Tab",
        "average" : "Not Implemented yet, manually select values in the Export Tab",
        "outfile" : "Not Implemented yet, manually select values in the Export Tab",
    },
    "sensor" : {
