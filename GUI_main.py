...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        try:
            ...
            # otherwise try to read the version.txt file, which should be generated by the build server
            # sys._MEIPASS is a pyinstaller thing, it's the path to the extracted files
            try:
        ...
        self.setWindowTitle(f"CC's Spectrometer Automation Tool {self.version}")
