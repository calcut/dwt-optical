...
def OverlayPlot(foldername,Current,WavelengthAverage,AverageTransArray,AverageMinimaArray,FileNames,OverlaySensors,OverlaySamples,AllPlot,Samples,Sensors,DataSet,OptoSky_Select,SpectraWiz_Select,Normalise,WMin,WMax):
    import matplotlib.pyplot as plt
    import os
    
    Slash='/'
    #Current=os.getcwd()
    New=Current+Slash+foldername+'_Figures'+Slash+DataSet
    ...
    if os.path.isdir(NewPathMinFig)==False:
        ...
        NewPathMinFig=Current+Slash+foldername+'_Figures'+Slash+DataSet+Slash+'OverlayedPlots'
