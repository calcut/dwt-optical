...
from GeneralFunctions_17_06_22 import FWHM
from GeneralFunctions_17_06_22 import CreateBlank
from GeneralFunctions_17_06_22 import WavExtract
from GeneralFunctions_17_06_22 import TransExtract
from GeneralFunctions_17_06_22 import Format

from FittingFunctions_17_06_22 import PolynomialBasedCut
from FittingFunctions_17_06_22 import SmoothAndSelect

from FittingSubFunctions_17_06_22 import Reframe

from SiaFunctions_17_06_22 import Normalise
from SiaFunctions_17_06_22 import Interpolate
import os
import csv

# SpectraWiz
def SpectraWiz(DataSet,SampleNames,Sensors,FileNames,Smooth,SmoothPoints,NormaliseQ,InterpolateQ,SamplingRate,TypeM,WMin,WMax):
    ...
    for i in range(len(FolderDir)):
        ...
        for j in range(len(FileDir)):
            for jj in range(len(FileDir)):
                FileTemp=FileDir[jj]
                FlagTemp=FileTemp.find(".EP")
            if FlagTemp>0:
                FlagEp=1
            else:
                FlagEp=0
            ...
            if(flag<0):
                ...
                [WavArray,TransArray]=Format(Data,WMin)
                ...
                for i in range(len(TransArray)):
                    Temp=Wavelength[i]
                    if Temp>=WMin and Flag1==0:
                        Cut1=i
                        Flag1=1
                    if Temp>=WMax and Flag2==0:
                        Cut2=i
                        Flag2=1
                if not Cut1:
                    Cut1=0
        ...
        for P in range(len(AverageTrans)):           
            AverageTrans[P]=AverageTrans[P]/(len(FileDir)-FlagEp)
        AverageTransArray.append(AverageTrans)
                
    return MinimaArray, FWHMArray, HeightArray, AverageTransArray,WavelengthAverage

# Optosky
def Optosky(DataSet,SampleNames,Sensors,FileNames,Smooth,SmoothPoints,NormaliseQ,InterpolateQ,SamplingRate,TypeM,WMin,WMax):
